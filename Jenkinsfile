    ...
    stages{
       ...
       stage ('cloneing')
       {
        ...
        stage('Push Docker image to ECR') {
            ...
            docker tag pycube-repo:latest ${AWS_ACCOUNT_ID}.dkr.ecr.us-east-1.amazonaws.com/pycube-repo:latest

            docker push ${AWS_ACCOUNT_ID}.dkr.ecr.us-east-1.amazonaws.com/pycube-repo:latest'''
        }
    }
}
